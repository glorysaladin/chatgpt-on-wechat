...
curl --location --request GET 'https://open.feishu.cn/open-apis/sheets/v2/spreadsheets/TmvnsdGP2hZYe6tIrllcpj1unGc/values/f0cbff!A2:C200?valueRenderOption=ToString&dateTimeRenderOption=FormattedString' \
